...
const OpenVAS = () => {
    ...
    return (
        ...
        <h1>OpenVAS Framework</h1>
        <div className='section-1'>
            <h2>What is OpenVAS Framework</h2>
            <Divider />
            <p>
        ...
        <div className='section-1'>
            ...
            <p>Install the code from <a href="https://www.kali.org/tools/OpenVAS-framework/">here</a></p>
        </div>
        <div className='section-1'>
            <h2>Extra Resources</h2>
            <Divider />
            <ul>
                <h4 onClick={onClick("https://github.com/rapid7/OpenVAS-framework/wiki/Nightly-Installers")} className="link-hover">
                    Downloads/Installation Guide
                </h4>
                <h4 onClick={onClick("https://OpenVAS.help.rapid7.com")} className="link-hover">
                    Documentation
                </h4>
                <h4 onClick={onClick("https://github.com/rapid7/OpenVAS-framework")} className="link-hover">
                    GitHub Repository
                </h4>
            </ul>
        </div>
